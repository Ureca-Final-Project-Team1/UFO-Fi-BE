...
public class NotificationSettingsService {
     ...
     * 3. 설정 목록 반환
     */
    public NotificationSettingsReadRes getNotificationSettings(Long userId) {
        ...
        return NotificationSettingsReadRes.from(settings, isTradeAll);
    }
    ...
    public void updateNotificationSettings(Long userId, NotificationType type, boolean enable) {
        ...
        NotificationSettings setting = notificationRepository.findByUserId(userId)
                .orElseThrow(() -> new GlobalException(NotificationErrorCode.NO_NOTIFICATION_SETTINGS));
