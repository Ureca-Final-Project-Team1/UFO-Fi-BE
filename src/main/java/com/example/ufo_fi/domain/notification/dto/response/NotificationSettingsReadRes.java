...
@AllArgsConstructor
@NoArgsConstructor
public class NotificationSettingsReadRes {
    ...
    public static NotificationSettingsReadRes from(NotificationSettings settings, boolean isTradeAll) {
        return NotificationSettingsReadRes.builder()
